...
/**
 * This class stands for GetCurrentGroupOrderID StructType
 * @subpackage Structs
 */
class GetCurrentGroupOrderID extends AbstractStructBase
{
    /**
     * The leagueShortcut
     * - maxOccurs: 1
    ...
    /**
     * Constructor method for GetCurrentGroupOrderID
     * @uses GetCurrentGroupOrderID::setLeagueShortcut()
     ...
     * @param string $leagueShortcut
     * @return \RrGeng\OpenligaDB\StructType\GetCurrentGroupOrderID
     */
