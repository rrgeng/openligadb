...
/**
 * This class stands for GetNextMatch StructType
 * @subpackage Structs
 */
class GetNextMatch extends AbstractStructBase
{
    /**
     * The leagueShortcut
     * - maxOccurs: 1
    ...
    /**
     * Constructor method for GetNextMatch
     * @uses GetNextMatch::setLeagueShortcut()
     ...
     * @param string $leagueShortcut
     * @return \RrGeng\OpenligaDB\StructType\GetNextMatch
     */
