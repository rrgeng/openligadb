...
/**
 * This class stands for GetLastChangeDateByGroupLeagueSaison StructType
 * @subpackage Structs
 */
class GetLastChangeDateByGroupLeagueSaison extends AbstractStructBase
{
    /**
     * The groupOrderID
     * - maxOccurs: 1
    ...
    /**
     * Constructor method for GetLastChangeDateByGroupLeagueSaison
     * @uses GetLastChangeDateByGroupLeagueSaison::setGroupOrderID()
     * @uses GetLastChangeDateByGroupLeagueSaison::setLeagueShortcut()
     * @uses GetLastChangeDateByGroupLeagueSaison::setLeagueSaison()
     ...
     * @param int $groupOrderID
     * @return \RrGeng\OpenligaDB\StructType\GetLastChangeDateByGroupLeagueSaison
     */
