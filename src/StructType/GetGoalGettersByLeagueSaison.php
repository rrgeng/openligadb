...
/**
 * This class stands for GetGoalGettersByLeagueSaison StructType
 * @subpackage Structs
 */
class GetGoalGettersByLeagueSaison extends AbstractStructBase
{
    /**
     * The leagueShortcut
     * - maxOccurs: 1
    ...
    /**
     * Constructor method for GetGoalGettersByLeagueSaison
     * @uses GetGoalGettersByLeagueSaison::setLeagueShortcut()
     * @uses GetGoalGettersByLeagueSaison::setLeagueSaison()
     ...
     * @param string $leagueShortcut
     * @return \RrGeng\OpenligaDB\StructType\GetGoalGettersByLeagueSaison
     */
