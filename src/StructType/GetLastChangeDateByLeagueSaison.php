...
/**
 * This class stands for GetLastChangeDateByLeagueSaison StructType
 * @subpackage Structs
 */
class GetLastChangeDateByLeagueSaison extends AbstractStructBase
{
    ...
    /**
     * Constructor method for GetLastChangeDateByLeagueSaison
     * @uses GetLastChangeDateByLeagueSaison::setLeagueShortcut()
     * @uses GetLastChangeDateByLeagueSaison::setLeagueSaison()
     ...
     * @param string $leagueShortcut
     * @return \RrGeng\OpenligaDB\StructType\GetLastChangeDateByLeagueSaison
     */
