...
/**
 * This class stands for GetMatchdataByGroupLeagueSaisonJSON StructType
 * @subpackage Structs
 */
class GetMatchdataByGroupLeagueSaisonJSON extends AbstractStructBase
{
    /**
     * The groupOrderID
     * - maxOccurs: 1
    ...
    /**
     * Constructor method for GetMatchdataByGroupLeagueSaisonJSON
     * @uses GetMatchdataByGroupLeagueSaisonJSON::setGroupOrderID()
     * @uses GetMatchdataByGroupLeagueSaisonJSON::setLeagueShortcut()
     * @uses GetMatchdataByGroupLeagueSaisonJSON::setLeagueSaison()
     ...
     * @param int $groupOrderID
     * @return \RrGeng\OpenligaDB\StructType\GetMatchdataByGroupLeagueSaisonJSON
     */
