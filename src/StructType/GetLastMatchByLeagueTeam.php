...
/**
 * This class stands for GetLastMatchByLeagueTeam StructType
 * @subpackage Structs
 */
class GetLastMatchByLeagueTeam extends AbstractStructBase
{
    /**
     * The leagueId
     * - maxOccurs: 1
    ...
    /**
     * Constructor method for GetLastMatchByLeagueTeam
     * @uses GetLastMatchByLeagueTeam::setLeagueId()
     * @uses GetLastMatchByLeagueTeam::setTeamId()
     * @param int $leagueId
     * @param int $teamId
     */
     ...
     * Set leagueId value
     * @param int $leagueId
     * @return \RrGeng\OpenligaDB\StructType\GetLastMatchByLeagueTeam
     */
