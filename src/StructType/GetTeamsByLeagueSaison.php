...
/**
 * This class stands for GetTeamsByLeagueSaison StructType
 * @subpackage Structs
 */
class GetTeamsByLeagueSaison extends AbstractStructBase
{
    ...
    /**
     * Constructor method for GetTeamsByLeagueSaison
     * @uses GetTeamsByLeagueSaison::setLeagueShortcut()
     * @uses GetTeamsByLeagueSaison::setLeagueSaison()
     ...
     * @param string $leagueShortcut
     * @return \RrGeng\OpenligaDB\StructType\GetTeamsByLeagueSaison
     */
