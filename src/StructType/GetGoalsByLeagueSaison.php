...
/**
 * This class stands for GetGoalsByLeagueSaison StructType
 * @subpackage Structs
 */
class GetGoalsByLeagueSaison extends AbstractStructBase
{
    /**
     * The leagueShortcut
     * - maxOccurs: 1
    ...
    /**
     * Constructor method for GetGoalsByLeagueSaison
     * @uses GetGoalsByLeagueSaison::setLeagueShortcut()
     * @uses GetGoalsByLeagueSaison::setLeagueSaison()
     ...
     * @param string $leagueShortcut
     * @return \RrGeng\OpenligaDB\StructType\GetGoalsByLeagueSaison
     */
